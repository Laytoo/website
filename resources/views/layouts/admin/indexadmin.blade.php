...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{url('/')}}/adminn/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="{{url('/')}}/adminn/css/skins/_all-skins.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{url('/')}}/adminn/index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>Pan</span>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('/')}}/adminn/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('/')}}/fotos/{{Auth::user()->image}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::user()->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{url('/')}}/fotos/{{Auth::user()->image}}" class="img-circle" alt="User Image">
...
<script src="{{url('/')}}/adminn/js/demo.js"></script>
<script>
